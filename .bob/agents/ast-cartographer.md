...
description: Extracts language-agnostic Abstract Syntax Trees (AST) using Tree-sitter, builds directed call graphs, computes cyclomatic complexity per function, generates ER diagrams from schema definitions, and detects circular or dead code paths.
groups:
  - read
  - execute
---
