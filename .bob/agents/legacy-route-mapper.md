...
description: Maps all HTTP routes in a Flask/Django/FastAPI application. Identifies unprotected endpoints, missing auth, CORS issues. Produces route inventory for migration planning.
groups:
  - read
---
