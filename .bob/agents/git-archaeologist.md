...
description: Mines git commit history using PyDriller to detect latent vulnerabilities, high-churn hotspots, recurring bug patterns, and implicit team knowledge. Produces commit archaeology reports and tracks how technical debt evolved over time. Use before any deep migration or architectural decision.
groups:
  - read
  - execute
---
