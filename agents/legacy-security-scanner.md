...
description: >
  OWASP Top 10 security audit for legacy Python web applications. 
  Detects hardcoded secrets, injection vectors, auth bypasses, 
  insecure deserialization. Each finding includes remediation steps.
