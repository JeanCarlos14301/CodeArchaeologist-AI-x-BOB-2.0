...
description: >
  Generates missing tests for legacy Python code. Focuses on critical 
  paths identified by the audit. Produces pytest tests with fixtures 
  that pin current behavior as golden masters.
