...
description: >
  Proposes 3 Strangler Fig migration options for a legacy codebase 
  based on validated audit findings. Selects the first cut with 
  best value/risk ratio. Never invents metrics — numbers come from 
