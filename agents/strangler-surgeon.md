...
description: >
  Implements the first migration cut in FastAPI behind a Strangler Fig 
  facade. The characterization tests must pass against both legacy and 
  modern code. Writes ONLY under modern/. One repair attempt maximum.
