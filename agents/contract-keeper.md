...
description: >
  Writes characterization tests (pytest) that pin down the current 
  observable behavior of a legacy endpoint. Tests must pass against 
  legacy before migration begins. Writes ONLY to tests/characterization/.
