...
description: >
  Model Context Protocol (FastMCP) integration bridge. Connects CodeArchaeologist 
  to external telemetry sources (DuckDB analytical databases, SQLite runtimes, 
  GitHub API pull requests/issues, APM logs) to enrich static code findings with 
