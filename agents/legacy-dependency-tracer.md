...
description: >
  Traces Python import graph across all modules. Detects circular 
  imports, high coupling, orphan files. Outputs dependency matrix 
  for migration risk assessment.
