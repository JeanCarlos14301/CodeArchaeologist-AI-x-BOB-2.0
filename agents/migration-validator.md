...
description: >
  Validates that migrated code passes characterization tests. Runs 
  tests against legacy and modern, compares results, reports pass/fail 
  with evidence. If tests fail, provides the error log for repair.
