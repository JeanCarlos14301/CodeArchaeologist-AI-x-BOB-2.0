...
description: >
  Analyzes SQL queries embedded in Python code. Detects injection 
  vulnerabilities, unparameterized queries, and infers schema from 
  query patterns. Use when auditing database interaction in legacy code.
