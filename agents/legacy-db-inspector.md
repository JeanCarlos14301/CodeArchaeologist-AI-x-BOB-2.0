...
description: >
  Analyzes database schema from SQLite files, ORM models, and raw SQL 
  in code. Produces schema documentation, identifies undocumented 
  tables, and flags migration risks for data layer.
