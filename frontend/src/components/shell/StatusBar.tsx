...
export function StatusBar() {
  ...
  return (
    <footer className="relative flex h-7 items-center gap-4 overflow-hidden border-t border-line bg-canvas px-3 font-mono text-micro text-subtle">
      ...
      {dossier?.source_sha256 && <span className="hidden truncate lg:inline" title={dossier.source_sha256}>sha256 {dossier.source_sha256.slice(0, 12)}</span>}
